		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 pull-left">
				<div class="form-group">
					<input type="text" placeholder="<?php esc_html_e('Longitude', 'listingo'); ?>" value="<?php echo esc_attr($profile_longitude); ?>" name="basics[longitude]" class="form-control" id="location-longitude-0" />
				</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 pull-left">
				<div class="form-group">
					<input type="text" placeholder="<?php esc_html_e('Latitude', 'listingo'); ?>" value="<?php echo esc_attr($profile_latitude); ?>" name="basics[latitude]" class="form-control" id="location-latitude-0" />
				</div>
			</div>
