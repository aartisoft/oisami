	...
	<div class="tg-detailpagehead">
		...
		<div class="tg-detailpageheadcontent">
			...
			<?php } else if( apply_filters('listingo_is_feature_allowed', $provider_category, 'appointments') === true 
				...
				<a class="tg-btn" href="<?php echo esc_url(get_permalink((int) $login_reg_link[0])); ?>?redirect=<?php echo esc_url(get_author_posts_url($author_profile->ID)); ?>"><?php esc_html_e('Make an appointment', 'listingo'); ?></a>
			<?php }?>
		</div>
	</div>
</div>