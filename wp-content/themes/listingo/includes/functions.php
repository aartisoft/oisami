...
if (!function_exists('listingo_get_post_date')) {
    ...
    function listingo_get_post_date($post_id = '') {
        global $post;
        echo '<time datetime="' . date_i18n('Y-m-d', strtotime(get_the_date('d-m-Y', $post_id))) . '"><i class="lnr lnr-calendar-full"></i><span>' . date_i18n(get_option('date_format'), strtotime(get_the_date('d-m-Y', $post_id))) . '</span></time>';
    }
