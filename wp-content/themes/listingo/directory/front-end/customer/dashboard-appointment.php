                                            ...
                                            <div class="tg-modalbody">
                                                ...
                                                <ul class="tg-invoicedetail">
                                                    ...
                                                    <?php if (!empty($time[0]) && !empty($time[1])) { ?>
                                                        <li><span><?php esc_html_e('Appointment Time:', 'listingo'); ?></span><span><?php echo date_i18n($time_format, strtotime('01-01-2016 ' . $time[0])); ?>&nbsp;-&nbsp;<?php echo date_i18n($time_format, strtotime('01-01-2016 ' . $time[1])); ?></span></li>
                                                    <?php } ?>
                                                    <?php if (!empty($booking_services[$apt_services])) { ?>
