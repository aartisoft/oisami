                ...
                <div class="tg-modalfoot">
                    ...
                    <div class="tg-availabletimeslotbox">
                        <div class="tg-dateandcount">
                            <time class="app_selected_date" datetime="02-02-2017"><?php echo esc_js(date_i18n(get_option('date_format'),strtotime(date('d-m-Y'))));?></time>
                        </div>
                        <div class="tg-timeslotsradio">
                            <?php listingo_get_appointment_slots($author_profile->ID,date('d-m-Y'), 'echo');?>
                        </div>
                    </div>
                    <div class="tg-btnbox">
...
$script = "jQuery(document).ready(function(){
            var defaul_date = '" . esc_js(date('d-m-Y') ) . "';
            ...
            jQuery('#tg-datepicker').datepicker({
                ...
                onSelect: function(dateText, inst) {
					...
					var dateFormatted = jQuery.datepicker.formatDate('dd-mm-yy', theDate);
