...
$booking_confirmed_default = 'Olá, %customer_name%!<br/><br/>
Esta é a confirmação de que seu agendamento de "%service%" com %provider% foi recebido.<br/>
Em breve você receberá um e-mail de aprovação ou cancelamento do seu agendamento.<br/>
<br/>
%signature%<br/>';

//Default template for booking cancellation
$booking_cancelled_default = 'Olá, %customer_name%!<br/><br/>
Esta é a confirmação de que seu agendamento de "%service%" com %provider% foi cancelado.<br/>
<br/>
%reason_title%<br/>
...
$booking_approved_default = 'Olá, %customer_name%!<br/><br/>
Esta é a confirmação de que seu agendamento de "%service%" com %provider% foi aprovada.<br/>
Estamos te esperando %appointment_date% às %appointment_time%.<br/>
<br/>
Lembre-se de fazer a confirmação telefônica com a clínica.<br/>
<br/>
%signature%<br/>
';
