    ...
    class Listingo_Profile_Menu {
        ...
        public static function listingo_profile_menu_top() {
            ...
            $avatar = apply_filters(
                    'listingo_get_media_filter', listingo_get_user_avatar(array('width' => 300, 'height' => 300), $current_user->ID), array('width' => 300, 'height' => 300)
            );
            ?>
        ...
        public static function listingo_get_avatar() {
            ...
            $avatar = apply_filters(
                'listingo_get_media_filter', listingo_get_user_avatar(array('width' => 300, 'height' => 300), $user_identity), array('width' => 300, 'height' => 300)
            );
