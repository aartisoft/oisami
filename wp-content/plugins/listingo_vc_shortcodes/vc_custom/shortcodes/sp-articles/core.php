 ...
 * @ Autor Themographics
 */
if (!class_exists('SC_VC_Article_Posts')) {

    class SC_VC_Article_Posts extends SC_VC_Core {

        public function __construct() {
            add_action("init", array(
                &$this,
                "listingo_vc_article_posts_init"));
        }
         ...
         * # return {options
         */
        public function listingo_vc_article_posts_init() {
            vc_map(array(
                "name" => esc_html__("SP Articles", 'listingo_vc_shortcodes'),
                "base" => "listingo_vc_article_posts",
                "class" => "",
                "controls" => "full",
                "show_settings_on_create" => true,
                "icon" => ListingoVCGlobalSettings::get_plugin_url() . '/vc_custom/shortcodes/sp-articles/images/screenshot.png',
                ...
                "params" => array(
                    ...
                    array(
                        ...
                        'value' => $this->listingo_vc_shortcodes_prepare_custom_posts('sp_articles', 50),                    
                    ),               
                    array(
                        'type' => 'vc_number',
                        'class' => '',
