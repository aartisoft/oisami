 ...
 * @ Autor Themographics
 */
if (!class_exists('SC_VC_Core_SP_Recent_Questions')) {

    class SC_VC_Core_SP_Recent_Questions extends SC_VC_Core {

        public function __construct() {
            add_action("init", array(
                &$this,
                "listingo_vc_recent_questions_init"));
        }
         ...
         * # return {options
         */
        public function listingo_vc_recent_questions_init() {
            vc_map(array(
                "name" => esc_html__("SP Recent Questions", 'listingo_vc_shortcodes'),
                "base" => "listingo_vc_recent_questions",
                "class" => "",
                "controls" => "full",
                "show_settings_on_create" => true,
                "icon" => ListingoVCGlobalSettings::get_plugin_url() . '/vc_custom/shortcodes/sp-recent-questions/images/screenshot.png',
                ...
                "params" => array(
                    ...
                    array(
                        ...
                        'heading' => 'Questions By',
                        'param_name' => 'posts_by',
                        "description" => esc_html__("Please select questions selection type.", 'listingo_vc_shortcodes'),
                    ),
                    array(
                        'type' => 'checkbox',
                        'save_always' => true,
                        ...
                        "description" => esc_html__("Select Categories to show questions from selected categories.", 'listingo_vc_shortcodes'),
                    ...
                    array(
                        'type' => 'checkbox',
                        'save_always' => true,
                        'heading' => esc_html__('Select Questions', 'listingo_vc_shortcodes'),
                        'param_name' => 'specific_posts',
                        "description" => esc_html__("Please select questions to show", 'listingo_vc_shortcodes'),
    ...
    new SC_VC_Core_SP_Recent_Questions();
}