 ...
 * @ Autor Themographics
 */
if (!class_exists('SC_VC_Core_SP_Featured_Listings')) {

    class SC_VC_Core_SP_Featured_Listings extends SC_VC_Core {

        public function __construct() {
            add_action("init", array(
                &$this,
                "listingo_vc_featured_listing_init"));
        }
         ...
         * # return {options
         */
        public function listingo_vc_featured_listing_init() {
            vc_map(array(
                "name" => esc_html__("SP Featured Users", 'listingo_vc_shortcodes'),
                "base" => "listingo_vc_featured_listing",
                "class" => "",
                "controls" => "full",
                ...
                "params" => array(
                    ...
                    array(
                        ...
                        "value" => array(
                            ...
                            esc_html__("By Users", 'listingo_vc_shortcodes') => "by_posts",
                        ),
                        'heading' => 'Users By',
                        'param_name' => 'posts_by',
    ...
    new SC_VC_Core_SP_Featured_Listings();
}