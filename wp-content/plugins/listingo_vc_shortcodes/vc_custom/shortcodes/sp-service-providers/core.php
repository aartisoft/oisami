 ...
 * @ Autor Themographics
 */
if (!class_exists('SC_VC_Core_Sp_Service_Providers')) {

    class SC_VC_Core_Sp_Service_Providers extends SC_VC_Core {

        public function __construct() {
            add_action("init", array(
                &$this,
                "listingo_vc_service_providers_init"));
        }
         ...
         * # return {options
         */
        public function listingo_vc_service_providers_init() {
            vc_map(array(
                "name" => esc_html__("SP Listingo", 'listingo_vc_shortcodes'),
                "base" => "listingo_vc_sp_service_providers",
                "class" => "",
                "controls" => "full",
                "show_settings_on_create" => true,
                "icon" => ListingoVCGlobalSettings::get_plugin_url() . '/vc_custom/shortcodes/sp-service-providers/images/screenshot.png',
    ...
    new SC_VC_Core_Sp_Service_Providers();
}