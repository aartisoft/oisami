...
<p><?php echo sprintf( __( 'To redeem your discount use coupon code %s during checkout or click on the following coupon:', WC_SC_TEXT_DOMAIN ), '<strong><code>' . $coupon_code . '</code></strong>' ); ?></p>
...
<div style="margin: 10px 0; text-align: center;" title="<?php echo __( 'Click to visit store. This coupon will be applied automatically.', WC_SC_TEXT_DOMAIN ); ?>">
...
<center><a href="<?php echo ( ! empty( $url ) ) ? $url : home_url(); ?>"><?php echo sprintf( __( 'Visit Store',WC_SC_TEXT_DOMAIN ) ); ?></a></center>

<?php if ( ! empty( $from ) ) { ?>
	<p><?php echo __( 'You got this gift card', WC_SC_TEXT_DOMAIN ) . ' ' . $from . $sender; ?></p>
<?php } ?>
