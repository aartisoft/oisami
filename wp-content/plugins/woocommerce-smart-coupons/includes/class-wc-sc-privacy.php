		...
		public function account_settings( $settings ) {
			$insert_setting = array(
				array(
					...
					'desc_tip'    => __( 'Store Credit/Gift Certificate that are stored for customers via coupons. If erased, the customer will not be able to use the coupons.', WC_SC_TEXT_DOMAIN ),
