            ...
            <table class="pw-form-table">
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon" title="<?php _e('Enter Rule name', 'pw_wc_advanced_gift') ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon" title="This Gifts rule is only for register user in site">
                            ?
                        </div>
                    </th>
                    <td>
                        <input type="radio" name="pw_register_user" class="pw_register_user"
                               value="yes" <?php checked($pw_register_user, "yes"); ?>
                               checked><?php _e('Yes', 'pw_wc_advanced_gift') ?>
                        <input type="radio" name="pw_register_user" class="pw_register_user"
                               value="no" <?php checked($pw_register_user, "no"); ?>><?php _e('No', 'pw_wc_advanced_gift') ?>
                    </td>
                </tr>
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('How many times this Gifts Rule can be used before it is void.', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr class="pw_gifts_limit_user">
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('How many times this Gifts Rule can be used by an individual user.user ID for logged in users.', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('number select gift in this rule! (if you selected multi product or category in above for gift)', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr class="can_several_gift_tr">
                    <th>
                        <?php _e('User Can choose a gifts in several times', 'pw_wc_advanced_gift'); ?>
            ...
            <table class="pw-form-table">
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('if At least one of the products assigned to cart , this Rule is exclude', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e(' At least one of the products assigned to category from list must be included in cart ', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                if (defined('plugin_dir_url_pw_woo_brand')) {
                    ...
                    <tr>
                        <th>
                            ...
                            <div class="pw-help-icon"
                                 title="<?php _e(' At least one of the products assigned to brand_depends from list must be included in cart ', 'pw_wc_advanced_gift'); ?>">
                                ?
                            </div>
                        </th>
                        <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('Which users can select gifts', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('Which roles can select gifts', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('Disable this rule if any coupon is applied in cart', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('Subtotal cart to offer the gifts , if you set min/max please use `:` for example 10:30', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('Enter Sum of item quantities products in cart', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        <?php _e('Orders count completed', 'pw_wc_advanced_gift') ?>
                        <div class="pw-help-icon"
                             title="<?php _e('Enter number of orders', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('Disable Gifts if any gift was to cart', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('If activated, the gift will be added to cart Automatically', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
                        <input type="radio" name="gift_auto_to_cart"
                               value="yes" <?php checked($gift_auto_to_cart, "yes"); ?>><?php _e('Yes', 'pw_wc_advanced_gift'); ?>
                        <input type="radio" name="gift_auto_to_cart"
                ...
                <tr>
                    <th>
                        ...
                        <div class="pw-help-icon"
                             title="<?php _e('If activated, the gift will be displayed in the product page', 'pw_wc_advanced_gift'); ?>">
                            ?
                        </div>
                    </th>
                    <td>
