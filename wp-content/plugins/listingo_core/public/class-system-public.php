            ...
            if ($_post != null) {
                if ($_post && 
					( 
						...
						|| preg_match('/sp_authentication/', $_post->post_content)
						|| preg_match('/listingo_auth/', $_post->post_content)
						|| preg_match('/sp_authentication_signin/', $_post->post_content)
						|| preg_match('/sp_authentication_signup/', $_post->post_content)
					)
				) {
