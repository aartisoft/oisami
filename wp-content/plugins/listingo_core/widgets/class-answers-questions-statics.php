...
//register widget
function listingo_register_listingo_statics_widgets() {
	register_widget( 'Listingo_AQ_Statics' );
}
add_action( 'widgets_init', 'listingo_register_listingo_statics_widgets' );