...
//register widget
function listingo_register_listingo_latestposts_widgets() {
	register_widget( 'Listingo_LatestPosts' );
}
add_action( 'widgets_init', 'listingo_register_listingo_latestposts_widgets' );
