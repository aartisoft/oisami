...
//register widget
function listingo_registerlistingo_recentquestion_widgets() {
	register_widget( 'Listingo_RecentQuestion' );
}
add_action( 'widgets_init', 'listingo_registerlistingo_recentquestion_widgets' );